...
the header and footer. It declares with `ngApp` that this is `workflow-composer`,
...
"workflow-composer" will rename the resultant CSS and JavaScript placed in `build/`,
